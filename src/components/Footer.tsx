...
export function Footer() {
  ...
  const quickLinks = [
    "About Us", "How It Works", "Safety Measures", 
    "Partner with Us", "Careers", "Press & Media"
  ];

  const services = [
    "Bus Booking", "Train Booking", "Flight Booking", 
    "Hotel Booking", "Travel Insurance", "Group Booking"
  ];
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              >
                ...
                travel tips, and special promotions tailored just for you.
              </motion.p>
              <motion.div 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            >
              <div className="flex items-center mb-8">
                ...
                >
                  <div className="w-8 h-8 flex items-center justify-center font-bold text-xl">T</div>
                </motion.div>
                <div>
                  <h1 className="text-2xl font-bold">TransportBooking</h1>
                  <p className="text-sm text-gray-400 font-medium">Your Journey Starts Here</p>
                </div>
              </div>
              <p className="text-gray-400 mb-8 leading-relaxed text-lg">
                We make travel booking simple, safe, and affordable. Connect with millions 
                of travelers and explore the world with confidence.
              </p>
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  { Icon: Phone, title: "+1 (555) 123-4567", subtitle: "24/7 Customer Support" },
                  { Icon: Mail, title: "support@transportbooking.com", subtitle: "For general inquiries" },
                  { Icon: MapPin, title: "123 Business Street", subtitle: "New York, NY 10001" }
